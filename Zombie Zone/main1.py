...
class Game:
    ...
    def load_data(self):
        ...
        self.player_mini = pg.transform.scale(self.player_img, (32, 32))
        self.bullet_images = {}
    ...
    def draw(self):
        ...
        draw_lives(self.screen, WIDTH / 2, 5, self.player.lives, self.player_mini)
        if self.paused:
    ...
    def show_start_screen(self):
        ...
        if self.starting:
            ...
            self.draw_text("ZOMBIE..", self.hud_font, 100, CYAN, WIDTH / 2, HEIGHT / 2 - 50, align = "center")
